...
const translations = {
    en: {
        ...
        "chesster.appStatus": "Chesster App",
        "chesster.registered": "Registered",
        "chesster.notRegistered": "Not registered",
        ...
        "student.tournaments.title": "Tournaments",
        "student.tournaments.leagueBadge": "League {{league}}",
        "student.tournaments.recent": "Recent tournaments",
        "student.tournaments.colDate": "Date",
        "student.tournaments.colName": "Tournament",
        "student.tournaments.colLeague": "League",
        "student.tournaments.colPlace": "Place",
        "student.tournaments.colDelta": "Δ rating",
        "student.tournaments.cadence": "Cadence",
        "student.tournaments.cadenceActive": "Active — last played {{date}}",
        "student.tournaments.cadenceOccasional": "Occasional — last played {{date}}",
        "student.tournaments.cadenceInactive": "Inactive — last played {{date}}",
        "student.tournaments.cadenceNever": "No tournaments yet",
        "student.tournaments.statsTotal": "Tournaments played",
        "student.tournaments.statsBestPlace": "Best place",
        "student.tournaments.statsAvgPlace": "Avg place",
        "student.tournaments.statsGained": "Total rating gained",
        "student.tournaments.sparkline": "Rating across last 10 tournaments",
        "student.tournaments.promoted": "Promoted {{from}} → {{to}} on {{date}}",
        "student.tournaments.demoted": "Demoted {{from}} → {{to}} on {{date}}",
        "student.tournaments.none": "No tournaments yet",
        "student.tournaments.streak": "Streak: {{current}} (best: {{longest}})",
        "student.tournaments.season": "Last {{days}} days",
        "student.tournaments.seasonPlayed": "Tournaments played",
        "student.tournaments.seasonBestPlace": "Best place",
        "student.tournaments.seasonDelta": "Total Δ rating",
        "student.tournaments.seasonEmpty": "No tournaments in the last {{days}} days",
        ...
        "branch.leaderboard.title": "Tournament Leaderboard",
        "branch.leaderboard.subtitle": "Top 10 by tournaments played (last 90 days)",
        "branch.leaderboard.leagueFilter": "League",
        "branch.leaderboard.leagueAll": "All Leagues",
        "branch.leaderboard.leagueA": "League A",
        "branch.leaderboard.leagueB": "League B",
        "branch.leaderboard.leagueC": "League C",
        "branch.leaderboard.colRank": "#",
        "branch.leaderboard.colName": "Student",
        "branch.leaderboard.colTournaments": "Tournaments",
        "branch.leaderboard.colTotalDelta": "Total Δ",
        "branch.leaderboard.empty": "No tournament participation in the last 90 days",
        "branch.leaderboard.loading": "Loading leaderboard…",
        "branch.leaderboard.error": "Could not load leaderboard",
        ...
        "admin.tournaments.parsing": "Parsing files…",
        "admin.tournaments.previewLeague": "League",
        "admin.tournaments.previewDate": "Date",
        "admin.tournaments.previewPlayers": "Players",
        "admin.tournaments.previewMatch": "Matched",
        "admin.tournaments.previewAmbiguous": "Ambiguous",
        "admin.tournaments.previewUnmatched": "Unmatched",
        "admin.tournaments.resolve": "Resolve",
        "admin.tournaments.skip": "Skip",
        "admin.tournaments.createNew": "Create new (coming soon)",
        "admin.uploads.skipRow": "⊘ Skip this row",
        "admin.uploads.createNewStudent": "+ Create new student card …",
        "admin.uploads.firstNameLabel": "First name",
        "admin.uploads.lastNameLabel": "Last name",
        "admin.uploads.branchLabel": "Branch",
        "admin.uploads.coachLabel": "Coach",
        "admin.uploads.coachOptional": "Coach (optional)",
        "admin.uploads.selectBranch": "Select branch",
        "admin.uploads.selectCoach": "— None —",
        "admin.uploads.branchRequired": "Branch is required",
        "admin.uploads.confirmNewStudent": "Confirm",
        "admin.uploads.newStudentReady": "New student ready",
        "admin.uploads.skipped": "Skipped",
        "admin.tournaments.importAll": "Import all",
        "admin.tournaments.importing": "Importing…",
        "admin.tournaments.importDone": "Imported {{inserted}} participants ({{skipped}} skipped)",
        "admin.tournaments.importFailed": "Import failed: {{error}}",
        "admin.tournaments.past": "Past tournaments",
        "admin.tournaments.noPast": "No tournaments imported yet",
        "admin.tournaments.delete": "Delete tournament",
        "admin.tournaments.deleteConfirm": "Delete this tournament and all its participants? This cannot be undone.",
        "admin.tournaments.noAccess": "You do not have permission to manage tournaments.",
        ...
        "access.permissions.manageTournaments": "Tournament Management",
        ...
        "leagues.leagueR": "Titled Tournament",
        ...
        "admin.ratings.viewUploads": "Upload History",
        "admin.ratings.historyTitle": "Upload History",
        "admin.ratings.colDocument": "Document",
        "admin.ratings.colType": "Type",
        "admin.ratings.colEffectiveDate": "Effective Date",
        "admin.ratings.colUploadedBy": "Uploaded By",
        "admin.ratings.colUploadedAt": "Uploaded At",
        "admin.ratings.colRows": "Rows",
        "admin.ratings.colActions": "Actions",
        "admin.ratings.filterAll": "All",
        "admin.ratings.filterTournament": "Tournaments",
        "admin.ratings.filterRating": "Rating CSVs",
        "admin.ratings.openBatch": "Open",
        "admin.ratings.unknownUser": "Unknown",
        "admin.ratings.empty": "No uploads yet",
        "admin.ratings.import": "Import Ratings",
        "admin.ratings.importCSV": "Import CSV",
        "admin.ratings.uploadCardTitle": "Upload Document",
        "admin.ratings.uploadHint": "Drag & drop .csv / .xlsx file here, or click to browse",
        ...
        "admin.ratings.creatingNewStudents": "Creating new students...",
        "admin.ratings.importingTournament": "Importing tournament results...",
        ...
        "admin.ratings.exportButton": "Current rating List",
        ...
        "admin.attendance.monFri": "Mon-Fri",
        ...
        "admin.attendance.noStudentsForCoach": "No students assigned to this coach yet",
        ...
        // Time slot edit modal (P3)
        "admin.attendance.editTimeSlot.title": "Edit Time Slot",
        "admin.attendance.editTimeSlot.startTime": "Start time",
        "admin.attendance.editTimeSlot.endTime": "End time",
        "admin.attendance.editTimeSlot.label": "Label (optional)",
        "admin.attendance.editTimeSlot.labelPlaceholder": "e.g. Group B",
        "admin.attendance.editTimeSlot.labelHelp": "Visible only in your calendar.",
        "admin.attendance.editTimeSlot.delete": "Delete",
        "admin.attendance.editTimeSlot.cancel": "Cancel",
        "admin.attendance.editTimeSlot.save": "Save",
        "admin.attendance.editTimeSlot.errBothTimes": "Please enter both start and end time.",
        "admin.attendance.editTimeSlot.errEndAfterStart": "End time must be after start time.",
        "admin.attendance.editTimeSlot.errSaveFailed": "Save failed.",
        "admin.attendance.editTimeSlot.errDeleteFailed": "Delete failed.",
        "admin.attendance.editTimeSlot.errPermission": "You do not have permission to edit this slot. Contact an admin.",
        "admin.attendance.editTimeSlot.deleteConfirm": "Delete this time slot? Any students assigned to this index will lose their slot mapping.",
        "admin.attendance.editTimeSlot.notAvailable": "This slot has no DB id (likely a fallback row). Edits are not available yet.",
        "admin.attendance.editTimeSlot.effectiveFromNote": "Changes apply to {month} onward. Previous months remain unchanged.",
        "admin.attendance.editTimeSlot.selectCoachToEdit": "Select a coach to edit time slots",
        "admin.attendance.addTimeSlot.button": "Add Time Slot",
        "admin.attendance.addTimeSlot.title": "Add Time Slot",
        "admin.attendance.addTimeSlot.startTime": "Start time",
        "admin.attendance.addTimeSlot.endTime": "End time",
        "admin.attendance.addTimeSlot.label": "Label (optional)",
        "admin.attendance.addTimeSlot.labelPlaceholder": "e.g. Group B",
        "admin.attendance.addTimeSlot.labelHelp": "Visible only in your calendar.",
        "admin.attendance.addTimeSlot.cancel": "Cancel",
        "admin.attendance.addTimeSlot.save": "Add",
        "admin.attendance.addTimeSlot.appliesFromNote": "Applies from {month} onward. Previous months remain unchanged.",
        "admin.attendance.addTimeSlot.selectCoachFirst": "Select a specific coach first to add a time slot.",
        "admin.attendance.addTimeSlot.selectScheduleFirst": "Select a specific schedule first to add a time slot.",
        "admin.attendance.addTimeSlot.selectBranchFirst": "Select a branch first to add a time slot.",
        "admin.attendance.addTimeSlot.errBothTimes": "Please enter both start and end time.",
        "admin.attendance.addTimeSlot.errEndAfterStart": "End time must be after start time.",
        "admin.attendance.addTimeSlot.errDuplicate": "A slot with this start and end time already exists.",
        "admin.attendance.addTimeSlot.errSaveFailed": "Add failed.",
        "admin.attendance.addMenu.button": "Add",
        "admin.attendance.addMenu.student": "Student",
        "admin.attendance.addMenu.timeSlot": "Time Slot",
        ...
        "admin.attendance.searchOutOfScope": "This student is outside your assigned branches",
        ...
        "admin.attendance.confirmHideStudent": "Hide {name} from {month} onward? Previous months will keep their schedule.",
        ...
        "admin.attendance.studentHidden": "{name} hidden from {month} onward",
        ...
        "admin.coachKpi.kind.rated": "Rated Tournament",
        "admin.imports.roundsRequired": "Rounds required for rated tournaments (1–20)",
        "admin.imports.roundsFixedMismatch": "This tournament type has a fixed round count — switch to Rated Tournament for a different number",
        ...
        "tournaments.appRegisterNote": "Registration happens in the Chess Empire app — only registered app users can participate.",
        ...
        "tournaments.ineligibleForLeague": "Cannot register — your rating ({{rating}}) puts you in League {{studentLeague}}, not League {{league}}.",
        "tournaments.levelTooLow": "Cannot register — League C requires Level {{required}}+. You are on Level {{level}}: finish your Level {{level}} lessons to unlock League C tournaments.",
        "tournaments.noRazryad": "Registration is open only to students who hold a razryad.",
        "tournaments.guestsAdminOnly": "Guests can be added to Titled tournaments by an admin only.",
        "tournaments.titledOnlyNote": "Registration is open only to students who hold a razryad.",
        ...
        "tournaments.fee.free": "Free",
        "tournaments.registration.closesAt": "Registration Closes {{datetime}}",
        "tournaments.startAt": "Start {{time}}",
        "tournaments.countdown.label": "Registration closes in",
        "tournaments.countdown.days": "DAYS",
        "tournaments.countdown.hours": "HOURS",
        "tournaments.countdown.minutes": "MINUTES",
        "tournaments.countdown.seconds": "SECONDS",
        ...
        "admin.tournaments.col.branch": "Branch",
        "admin.tournaments.col.name": "Name",
        "admin.tournaments.col.date": "Date",
        "admin.tournaments.col.time": "Time",
        "admin.tournaments.col.format": "Format",
        "admin.tournaments.col.fee": "Fee",
        "admin.tournaments.col.rounds": "Rounds",
        "admin.tournaments.col.status": "Status",
        "admin.tournaments.col.registered": "Registered",
        "admin.tournaments.col.actions": "Actions",
        "admin.tournaments.col.surname": "Surname",
        "admin.tournaments.col.firstName": "First Name",
        "admin.tournaments.col.rating": "Rating",
        "admin.tournaments.col.coach": "Coach",
        "admin.tournaments.col.age": "Age",
        "admin.tournaments.action.edit": "Edit",
        "admin.tournaments.action.cancel": "Cancel",
        "admin.tournaments.action.delete": "Delete",
        "admin.tournaments.action.remove": "Remove",
        "admin.tournaments.action.viewParticipants": "View participants",
        "admin.tournaments.downloadExcel": "Download Excel",
        "admin.tournaments.excelFilenamePrefix": "Participants",
        "admin.tournaments.status.open": "Open",
        "admin.tournaments.status.closed": "Closed",
        ...
        "admin.tournaments.form.timeFormat": "Time Format",
        "admin.tournaments.form.fee": "Registration Fee (KZT)",
        "admin.tournaments.form.rounds": "Number of Rounds",
        "admin.tournaments.form.capacity": "Capacity",
        "admin.tournaments.form.status": "Status",
        "admin.tournaments.form.league": "League",
        "admin.tournaments.form.deadline": "Registration deadline",
        "admin.tournaments.confirmDelete": "Delete this tournament? This will also delete all registrations.",
        "admin.tournaments.confirmCancel": "Cancel this tournament? Existing registrations remain but no new ones can be added.",
        "admin.tournaments.confirmRemove": "Remove this registration?",
        ...
        "admin.tournaments.cancelled": "Tournament cancelled",
        "admin.tournaments.registrationRemoved": "Registration removed",
        "admin.tournaments.removeError.not_found": "Registration already removed",
        "admin.tournaments.error": "Error",
        "admin.tournaments.accessDenied": "Access denied",
        "admin.tournaments.selectTournament": "Select a tournament",
        "admin.tournaments.noRegistrations": "No registrations yet",
        "admin.tournaments.noTournaments": "No tournaments yet",
        "admin.tournaments.mobile.statActive": "Active",
        "admin.tournaments.mobile.statRegistrations": "Registrations",
        "admin.tournaments.mobile.statWeekend": "This weekend",
        "admin.tournaments.mobile.filled": "Filled",
        "admin.tournaments.mobile.participants": "Participants",
        "admin.tournaments.mobile.roundsSuffix": "rounds",
        "admin.tournaments.addGuest": "+ Add guest",
        "admin.tournaments.guestBadge": "Guest",
        "admin.tournaments.col.phone": "Phone",
        "admin.tournaments.col.email": "Email",
        "admin.tournaments.guestModal.title": "Add guest player",
        "admin.tournaments.guestForm.firstName": "First name",
        "admin.tournaments.guestForm.lastName": "Last name",
        "admin.tournaments.guestForm.phone": "Phone",
        "admin.tournaments.guestForm.age": "Age",
        "admin.tournaments.guestForm.rating": "Rating (optional)",
        "admin.tournaments.guestForm.submit": "Register guest",
        "admin.tournaments.guestRegistered": "Guest registered.",
        "admin.tournaments.duplicateGuest": "This email is already registered for this tournament.",
        "admin.tournaments.ineligibleGuest": "Rating doesn't match league {tournament_league} (guest fits league {guest_league}).",
        "admin.tournaments.form.leagueR": "Titled / Ranked (R)",
        "admin.tournaments.noRazryad": "This student has no razryad and can't self-register for a Titled tournament.",
        "admin.tournaments.guestsAdminOnly": "Only admins can add guests to Titled tournaments.",
        "admin.tournaments.invalid_first_name": "First name is required.",
        "admin.tournaments.invalid_last_name": "Last name is required.",
        "admin.tournaments.invalid_phone": "Phone looks off — use +7 (XXX) XXX-XX-XX.",
        "admin.tournaments.invalid_email": "That email doesn't look right.",
        "admin.tournaments.invalid_age": "Age must be between 4 and 99.",
        "admin.tournaments.invalid_rating": "Rating must be 0 to 3500."
    },
    kk: {
        "common.brand": "Chess Empire",
        ...
        "chesster.appStatus": "Chesster қолданбасы",
        "chesster.registered": "Тіркелген",
        "chesster.notRegistered": "Тіркелмеген",
        ...
        "student.tournaments.title": "Турнирлер",
        "student.tournaments.leagueBadge": "{{league}} лигасы",
        "student.tournaments.recent": "Соңғы турнирлер",
        "student.tournaments.colDate": "Күні",
        "student.tournaments.colName": "Турнир",
        "student.tournaments.colLeague": "Лига",
        "student.tournaments.colPlace": "Орын",
        "student.tournaments.colDelta": "Δ рейтинг",
        "student.tournaments.cadence": "Белсенділік",
        "student.tournaments.cadenceActive": "Белсенді — соңғы ойын {{date}}",
        "student.tournaments.cadenceOccasional": "Кейде — соңғы ойын {{date}}",
        "student.tournaments.cadenceInactive": "Белсенді емес — соңғы ойын {{date}}",
        "student.tournaments.cadenceNever": "Әзірге турнирлер жоқ",
        "student.tournaments.statsTotal": "Турнирлер ойналды",
        "student.tournaments.statsBestPlace": "Үздік орын",
        "student.tournaments.statsAvgPlace": "Орташа орын",
        "student.tournaments.statsGained": "Жинаған рейтинг",
        "student.tournaments.sparkline": "Соңғы 10 турнирдегі рейтинг",
        "student.tournaments.promoted": "{{from}} → {{to}} көтерілді ({{date}})",
        "student.tournaments.demoted": "{{from}} → {{to}} төмендеді ({{date}})",
        "student.tournaments.none": "Әзірге турнирлер жоқ",
        "student.tournaments.streak": "Серия: {{current}} (рекорд: {{longest}})",
        "student.tournaments.season": "Соңғы {{days}} күн",
        "student.tournaments.seasonPlayed": "Турнирлер ойналды",
        "student.tournaments.seasonBestPlace": "Үздік орын",
        "student.tournaments.seasonDelta": "Жалпы Δ рейтинг",
        "student.tournaments.seasonEmpty": "Соңғы {{days}} күнде турнирлер жоқ",
        ...
        "branch.leaderboard.title": "Турнир рейтингі",
        "branch.leaderboard.subtitle": "Турнирлер бойынша топ 10 (соңғы 90 күн)",
        "branch.leaderboard.leagueFilter": "Лига",
        "branch.leaderboard.leagueAll": "Барлық лигалар",
        "branch.leaderboard.leagueA": "A лигасы",
        "branch.leaderboard.leagueB": "B лигасы",
        "branch.leaderboard.leagueC": "C лигасы",
        "branch.leaderboard.colRank": "#",
        "branch.leaderboard.colName": "Оқушы",
        "branch.leaderboard.colTournaments": "Турнирлер",
        "branch.leaderboard.colTotalDelta": "Жалпы Δ",
        "branch.leaderboard.empty": "Соңғы 90 күнде турнирлерге қатысу жоқ",
        "branch.leaderboard.loading": "Рейтинг жүктелуде…",
        "branch.leaderboard.error": "Рейтингті жүктеу мүмкін болмады",
        ...
        "admin.tournaments.parsing": "Файлдар талдануда…",
        "admin.tournaments.previewLeague": "Лига",
        "admin.tournaments.previewDate": "Күні",
        "admin.tournaments.previewPlayers": "Ойыншылар",
        "admin.tournaments.previewMatch": "Сәйкестендірілген",
        "admin.tournaments.previewAmbiguous": "Күмәнді",
        "admin.tournaments.previewUnmatched": "Сәйкессіз",
        "admin.tournaments.resolve": "Шешу",
        "admin.tournaments.skip": "Өткізіп жіберу",
        "admin.tournaments.createNew": "Жаңа оқушы құру (жақын арада)",
        "admin.uploads.skipRow": "⊘ Бұл жолды өткізіп жіберу",
        "admin.uploads.createNewStudent": "+ Жаңа оқушы картасын құру …",
        "admin.uploads.firstNameLabel": "Аты",
        "admin.uploads.lastNameLabel": "Тегі",
        "admin.uploads.branchLabel": "Филиал",
        "admin.uploads.coachLabel": "Жаттықтырушы",
        "admin.uploads.coachOptional": "Жаттықтырушы (міндетті емес)",
        "admin.uploads.selectBranch": "Филиалды таңдаңыз",
        "admin.uploads.selectCoach": "— Жоқ —",
        "admin.uploads.branchRequired": "Филиал міндетті",
        "admin.uploads.confirmNewStudent": "Растау",
        "admin.uploads.newStudentReady": "Жаңа оқушы дайын",
        "admin.uploads.skipped": "Өткізілді",
        "admin.tournaments.importAll": "Барлығын импорттау",
        "admin.tournaments.importing": "Импортталуда…",
        "admin.tournaments.importDone": "{{inserted}} қатысушы импортталды ({{skipped}} өткізілді)",
        "admin.tournaments.importFailed": "Импорт сәтсіз аяқталды: {{error}}",
        "admin.tournaments.past": "Бұрынғы турнирлер",
        "admin.tournaments.noPast": "Әлі ешқандай турнир импортталмаған",
        "admin.tournaments.delete": "Турнирді жою",
        "admin.tournaments.deleteConfirm": "Бұл турнирді және барлық қатысушыларын жою керек пе? Қайтару мүмкін емес.",
        "admin.tournaments.noAccess": "Турнирлерді басқаруға рұқсатыңыз жоқ.",
        ...
        "coach.cadence.active": "Белсенді",
        "coach.cadence.occasional": "Кейде",
        "coach.cadence.inactive": "Белсенді емес",
        ...
        "access.permissions.manageTournaments": "Турнирлерді басқару",
        ...
        "leagues.leagueR": "Разрядшылар турнирі",
        ...
        "admin.ratings.viewUploads": "Жүктеу тарихы",
        "admin.ratings.historyTitle": "Жүктеу тарихы",
        "admin.ratings.colDocument": "Құжат",
        "admin.ratings.colType": "Түрі",
        "admin.ratings.colEffectiveDate": "Күн",
        "admin.ratings.colUploadedBy": "Жүктеген",
        "admin.ratings.colUploadedAt": "Жүктелген уақыт",
        "admin.ratings.colRows": "Жолдар",
        "admin.ratings.colActions": "Әрекеттер",
        "admin.ratings.filterAll": "Барлығы",
        "admin.ratings.filterTournament": "Турнирлер",
        "admin.ratings.filterRating": "Рейтинг CSV",
        "admin.ratings.openBatch": "Ашу",
        "admin.ratings.unknownUser": "Белгісіз",
        "admin.ratings.empty": "Жүктеулер әлі жоқ",
        "admin.ratings.import": "Рейтингтерді импорттау",
        "admin.ratings.importCSV": "CSV импорттау",
        "admin.ratings.uploadCardTitle": "Құжатты жүктеу",
        "admin.ratings.uploadHint": ".csv / .xlsx файлды осы жерге сүйреп апарыңыз немесе шерту арқылы таңдаңыз",
        ...
        "admin.ratings.creatingNewStudents": "Жаңа оқушылар жасалуда...",
        "admin.ratings.importingTournament": "Турнир нәтижелері жүктелуде...",
        ...
        "admin.ratings.ambiguousMatch": "Бірнеше сәйкестік",
        "admin.ratings.selectCorrectStudent": "Дұрыс оқушыны таңдаңыз...",
        "admin.ratings.ambiguous": "анықталмаған",
        "admin.ratings.disambiguateAge": "Жасы",
        "admin.ratings.disambiguateDob": "Туған күні",
        ...
        "admin.ratings.exportButton": "Ағымдағы рейтинг тізімі",
        ...
        "admin.attendance.noStudentsForCoach": "Бұл тренерге әлі оқушылар бекітілмеген",
        ...
        // Time slot edit modal (P3)
        "admin.attendance.editTimeSlot.title": "Уақытты өзгерту",
        "admin.attendance.editTimeSlot.startTime": "Басталу уақыты",
        "admin.attendance.editTimeSlot.endTime": "Аяқталу уақыты",
        "admin.attendance.editTimeSlot.label": "Атауы (міндетті емес)",
        "admin.attendance.editTimeSlot.labelPlaceholder": "мысалы, Б тобы",
        "admin.attendance.editTimeSlot.labelHelp": "Тек сіздің күнтізбеңізде көрінеді.",
        "admin.attendance.editTimeSlot.delete": "Жою",
        "admin.attendance.editTimeSlot.cancel": "Бас тарту",
        "admin.attendance.editTimeSlot.save": "Сақтау",
        "admin.attendance.editTimeSlot.errBothTimes": "Басталу және аяқталу уақытын енгізіңіз.",
        "admin.attendance.editTimeSlot.errEndAfterStart": "Аяқталу уақыты басталу уақытынан кейін болуы керек.",
        "admin.attendance.editTimeSlot.errSaveFailed": "Сақтау сәтсіз аяқталды.",
        "admin.attendance.editTimeSlot.errDeleteFailed": "Жою сәтсіз аяқталды.",
        "admin.attendance.editTimeSlot.errPermission": "Бұл слотты өзгертуге құқығыңыз жоқ. Әкімшіге хабарласыңыз.",
        "admin.attendance.editTimeSlot.deleteConfirm": "Бұл уақыт слотын жою керек пе? Осы индекске бекітілген оқушылар бекітуінен айырылады.",
        "admin.attendance.editTimeSlot.notAvailable": "Бұл слоттың дерекқорда ID жоқ (мүмкін резервтік жазба). Өңдеу әлі қолжетімді емес.",
        "admin.attendance.editTimeSlot.effectiveFromNote": "Өзгерістер {month} айынан бастап қолданылады. Алдыңғы айлар өзгеріссіз қалады.",
        "admin.attendance.editTimeSlot.selectCoachToEdit": "Слоттарды өңдеу үшін жаттықтырушыны таңдаңыз",
        "admin.attendance.addTimeSlot.button": "Уақыт слотын қосу",
        "admin.attendance.addTimeSlot.title": "Уақыт слотын қосу",
        "admin.attendance.addTimeSlot.startTime": "Басталу уақыты",
        "admin.attendance.addTimeSlot.endTime": "Аяқталу уақыты",
        "admin.attendance.addTimeSlot.label": "Атауы (міндетті емес)",
        "admin.attendance.addTimeSlot.labelPlaceholder": "мысалы, Б тобы",
        "admin.attendance.addTimeSlot.labelHelp": "Тек сіздің күнтізбеңізде көрінеді.",
        "admin.attendance.addTimeSlot.cancel": "Бас тарту",
        "admin.attendance.addTimeSlot.save": "Қосу",
        "admin.attendance.addTimeSlot.appliesFromNote": "{month} айынан бастап қолданылады. Алдыңғы айлар өзгеріссіз қалады.",
        "admin.attendance.addTimeSlot.selectCoachFirst": "Уақыт слотын қосу үшін алдымен нақты жаттықтырушыны таңдаңыз.",
        "admin.attendance.addTimeSlot.selectScheduleFirst": "Уақыт слотын қосу үшін алдымен нақты кестені таңдаңыз.",
        "admin.attendance.addTimeSlot.selectBranchFirst": "Уақыт слотын қосу үшін алдымен филиалды таңдаңыз.",
        "admin.attendance.addTimeSlot.errBothTimes": "Басталу және аяқталу уақытын енгізіңіз.",
        "admin.attendance.addTimeSlot.errEndAfterStart": "Аяқталу уақыты басталу уақытынан кейін болуы керек.",
        "admin.attendance.addTimeSlot.errDuplicate": "Осындай басталу және аяқталу уақыты бар слот бұрыннан бар.",
        "admin.attendance.addTimeSlot.errSaveFailed": "Қосу сәтсіз аяқталды.",
        "admin.attendance.addMenu.button": "Қосу",
        "admin.attendance.addMenu.student": "Оқушы",
        "admin.attendance.addMenu.timeSlot": "Уақыт слоты",
        ...
        "admin.attendance.searchOutOfScope": "Бұл оқушы сіздің филиалдарыңыздан тыс",
        ...
        "admin.attendance.confirmHideStudent": "{name} оқушысын {month} айынан бастап жасыру керек пе? Алдыңғы айлардың кестесі сақталады.",
        ...
        "admin.attendance.studentHidden": "{name} {month} айынан бастап жасырылды",
        ...
        "admin.coachKpi.kind.rated": "Рейтингтік турнир",
        "admin.imports.roundsRequired": "Рейтингтік турнирлер үшін раундтар саны қажет (1–20)",
        "admin.imports.roundsFixedMismatch": "Бұл турнир түрінде бекітілген раундтар саны бар — басқа санды Rated Tournament арқылы жүктеңіз",
        ...
        "tournaments.appRegisterNote": "Тіркеу Chess Empire қосымшасында өтеді — тек тіркелген қолданушылар қатыса алады.",
        ...
        "tournaments.ineligibleForLeague": "Тіркеу мүмкін емес — сіздің рейтингіңіз ({{rating}}) {{studentLeague}} лигасына сәйкес, {{league}} лигасына емес.",
        "tournaments.levelTooLow": "Тіркеу мүмкін емес — C лигасына {{required}}-деңгей және одан жоғары қажет. Сіз {{level}}-деңгейдесіз: C лигасы турнирлерін ашу үшін {{level}}-деңгей сабақтарын аяқтаңыз.",
        "tournaments.noRazryad": "Тіркеу тек разряды бар оқушыларға қолжетімді.",
        "tournaments.guestsAdminOnly": "Разрядшылар турнирлеріне қонақтарды тек әкімші қоса алады.",
        "tournaments.titledOnlyNote": "Тіркеу тек разряды бар оқушыларға ашық.",
        ...
        "tournaments.fee.kzt": "{{amount}} ₸",
        "tournaments.fee.free": "Тегін",
        "tournaments.registration.closesAt": "Тіркеу жабылады: {{datetime}}",
        "tournaments.startAt": "Басталу {{time}}",
        "tournaments.countdown.label": "Тіркеу жабылғанға дейін",
        "tournaments.countdown.days": "КҮН",
        "tournaments.countdown.hours": "САҒАТ",
        "tournaments.countdown.minutes": "МИНУТ",
        "tournaments.countdown.seconds": "СЕК",
        ...
        "admin.tournaments.col.branch": "Филиал",
        "admin.tournaments.col.name": "Атауы",
        "admin.tournaments.col.date": "Күні",
        "admin.tournaments.col.time": "Уақыты",
        "admin.tournaments.col.format": "Формат",
        "admin.tournaments.col.fee": "Төлем",
        "admin.tournaments.col.rounds": "Турлар",
        "admin.tournaments.col.status": "Күй",
        "admin.tournaments.col.registered": "Тіркелді",
        "admin.tournaments.col.actions": "Әрекеттер",
        "admin.tournaments.col.surname": "Тегі",
        "admin.tournaments.col.firstName": "Аты",
        "admin.tournaments.col.rating": "Рейтинг",
        "admin.tournaments.col.coach": "Жаттықтырушы",
        "admin.tournaments.col.age": "Жасы",
        "admin.tournaments.action.edit": "Өңдеу",
        "admin.tournaments.action.cancel": "Болдырмау",
        "admin.tournaments.action.delete": "Жою",
        "admin.tournaments.action.remove": "Жою",
        "admin.tournaments.action.viewParticipants": "Қатысушыларды көру",
        "admin.tournaments.downloadExcel": "Excel жүктеу",
        "admin.tournaments.excelFilenamePrefix": "Қатысушылар",
        "admin.tournaments.status.open": "Ашық",
        "admin.tournaments.status.closed": "Жабық",
        ...
        "admin.tournaments.form.timeFormat": "Уақыт пішімі",
        "admin.tournaments.form.fee": "Тіркеу төлемі (теңге)",
        "admin.tournaments.form.rounds": "Турлар саны",
        "admin.tournaments.form.capacity": "Сыйымдылығы",
        "admin.tournaments.form.status": "Күй",
        "admin.tournaments.form.league": "Лига",
        "admin.tournaments.form.deadline": "Тіркеу мерзімі",
        "admin.tournaments.confirmDelete": "Бұл турнирді жоясыз ба? Барлық тіркеулер де жойылады.",
        "admin.tournaments.confirmCancel": "Бұл турнирді болдырмайсыз ба? Қолданыстағы тіркеулер сақталады, бірақ жаңасын қосуға болмайды.",
        "admin.tournaments.confirmRemove": "Бұл тіркеуді жоясыз ба?",
        "admin.tournaments.created": "Турнир жасалды",
        "admin.tournaments.updated": "Турнир жаңартылды",
        "admin.tournaments.deleted": "Турнир жойылды",
        "admin.tournaments.cancelled": "Турнир болдырмалды",
        "admin.tournaments.registrationRemoved": "Тіркеу жойылды",
        "admin.tournaments.removeError.not_found": "Тіркеу бұрын жойылған",
        "admin.tournaments.error": "Қате",
        "admin.tournaments.accessDenied": "Қол жеткізу тыйым салынған",
        "admin.tournaments.selectTournament": "Турнирді таңдаңыз",
        "admin.tournaments.noRegistrations": "Әзірше тіркеулер жоқ",
        "admin.tournaments.noTournaments": "Әзірше турнирлер жоқ",
        "admin.tournaments.mobile.statActive": "Белсенді",
        "admin.tournaments.mobile.statRegistrations": "Тіркеулер",
        "admin.tournaments.mobile.statWeekend": "Осы демалыста",
        "admin.tournaments.mobile.filled": "Толтырылды",
        "admin.tournaments.mobile.participants": "Қатысушылар",
        "admin.tournaments.mobile.roundsSuffix": "тур",
        "admin.tournaments.addGuest": "+ Қонақ қосу",
        "admin.tournaments.guestBadge": "Қонақ",
        "admin.tournaments.col.phone": "Телефон",
        "admin.tournaments.col.email": "Email",
        "admin.tournaments.guestModal.title": "Қонақ ойыншыны қосу",
        "admin.tournaments.guestForm.firstName": "Аты",
        "admin.tournaments.guestForm.lastName": "Тегі",
        "admin.tournaments.guestForm.phone": "Телефон",
        "admin.tournaments.guestForm.email": "Email",
        "admin.tournaments.guestForm.age": "Жасы",
        "admin.tournaments.guestForm.rating": "Рейтинг (міндетті емес)",
        "admin.tournaments.guestForm.submit": "Қонақты тіркеу",
        "admin.tournaments.guestRegistered": "Қонақ тіркелді.",
        "admin.tournaments.duplicateGuest": "Бұл email осы турнирге тіркелген.",
        "admin.tournaments.ineligibleGuest": "Рейтинг {tournament_league} лигасына сәйкес келмейді (қонақ {guest_league} лигасына сәйкес).",
        "admin.tournaments.form.leagueR": "Титулдық / Разрядшылар турнирі (R)",
        "admin.tournaments.noRazryad": "Бұл оқушының разряды жоқ — разрядшылар турниріне өзі тіркеле алмайды.",
        "admin.tournaments.guestsAdminOnly": "Разрядшылар турнирлеріне қонақтарды тек әкімші қоса алады.",
        "admin.tournaments.invalid_first_name": "Аты қажет.",
        "admin.tournaments.invalid_last_name": "Тегі қажет.",
        "admin.tournaments.invalid_phone": "Телефон форматы дұрыс емес — +7 (XXX) XXX-XX-XX қолданыңыз.",
        "admin.tournaments.invalid_email": "Email форматы дұрыс емес.",
        "admin.tournaments.invalid_age": "Жасы 4 пен 99 аралығында болуы керек.",
        "admin.tournaments.invalid_rating": "Рейтинг 0 мен 3500 аралығында болуы керек."
    },
    ru: {
        // Common
        ...
        "chesster.appStatus": "Приложение Chesster",
        "chesster.registered": "Зарегистрирован",
        "chesster.notRegistered": "Не зарегистрирован",
        ...
        "student.tournaments.title": "Турниры",
        "student.tournaments.leagueBadge": "Лига {{league}}",
        "student.tournaments.recent": "Последние турниры",
        "student.tournaments.colDate": "Дата",
        "student.tournaments.colName": "Турнир",
        "student.tournaments.colLeague": "Лига",
        "student.tournaments.colPlace": "Место",
        "student.tournaments.colDelta": "Δ рейтинг",
        "student.tournaments.cadence": "Активность",
        "student.tournaments.cadenceActive": "Активен — последняя игра {{date}}",
        "student.tournaments.cadenceOccasional": "Изредка — последняя игра {{date}}",
        "student.tournaments.cadenceInactive": "Неактивен — последняя игра {{date}}",
        "student.tournaments.cadenceNever": "Турниров пока не было",
        "student.tournaments.statsTotal": "Сыграно турниров",
        "student.tournaments.statsBestPlace": "Лучшее место",
        "student.tournaments.statsAvgPlace": "Среднее место",
        "student.tournaments.statsGained": "Прирост рейтинга",
        "student.tournaments.sparkline": "Рейтинг за последние 10 турниров",
        "student.tournaments.promoted": "Повышен {{from}} → {{to}} {{date}}",
        "student.tournaments.demoted": "Понижен {{from}} → {{to}} {{date}}",
        "student.tournaments.none": "Турниров пока не было",
        "student.tournaments.streak": "Серия: {{current}} (рекорд: {{longest}})",
        "student.tournaments.season": "Последние {{days}} дней",
        "student.tournaments.seasonPlayed": "Сыграно турниров",
        "student.tournaments.seasonBestPlace": "Лучшее место",
        "student.tournaments.seasonDelta": "Суммарный Δ рейтинга",
        "student.tournaments.seasonEmpty": "За последние {{days}} дней турниров не было",
        ...
        "branch.leaderboard.title": "Турнирный рейтинг",
        "branch.leaderboard.subtitle": "Топ-10 по числу турниров (последние 90 дней)",
        "branch.leaderboard.leagueFilter": "Лига",
        "branch.leaderboard.leagueAll": "Все лиги",
        "branch.leaderboard.leagueA": "Лига A",
        "branch.leaderboard.leagueB": "Лига B",
        "branch.leaderboard.leagueC": "Лига C",
        "branch.leaderboard.colRank": "#",
        "branch.leaderboard.colName": "Ученик",
        "branch.leaderboard.colTournaments": "Турниры",
        "branch.leaderboard.colTotalDelta": "Суммарный Δ",
        "branch.leaderboard.empty": "За последние 90 дней участия в турнирах не было",
        "branch.leaderboard.loading": "Загрузка рейтинга…",
        "branch.leaderboard.error": "Не удалось загрузить рейтинг",
        ...
        "admin.tournaments.parsing": "Разбор файлов…",
        "admin.tournaments.previewLeague": "Лига",
        "admin.tournaments.previewDate": "Дата",
        "admin.tournaments.previewPlayers": "Игроки",
        "admin.tournaments.previewMatch": "Сопоставлено",
        "admin.tournaments.previewAmbiguous": "Неоднозначно",
        "admin.tournaments.previewUnmatched": "Не найдено",
        "admin.tournaments.resolve": "Разрешить",
        "admin.tournaments.skip": "Пропустить",
        "admin.tournaments.createNew": "Создать ученика (скоро)",
        "admin.uploads.skipRow": "⊘ Пропустить строку",
        "admin.uploads.createNewStudent": "+ Создать карточку ученика …",
        "admin.uploads.firstNameLabel": "Имя",
        "admin.uploads.lastNameLabel": "Фамилия",
        "admin.uploads.branchLabel": "Филиал",
        "admin.uploads.coachLabel": "Тренер",
        "admin.uploads.coachOptional": "Тренер (необязательно)",
        "admin.uploads.selectBranch": "Выберите филиал",
        "admin.uploads.selectCoach": "— Не выбран —",
        "admin.uploads.branchRequired": "Филиал обязателен",
        "admin.uploads.confirmNewStudent": "Подтвердить",
        "admin.uploads.newStudentReady": "Новый ученик готов",
        "admin.uploads.skipped": "Пропущено",
        "admin.tournaments.importAll": "Импортировать всё",
        "admin.tournaments.importing": "Импорт…",
        "admin.tournaments.importDone": "Импортировано {{inserted}} участников ({{skipped}} пропущено)",
        "admin.tournaments.importFailed": "Импорт не удался: {{error}}",
        "admin.tournaments.past": "Прошедшие турниры",
        "admin.tournaments.noPast": "Турниры ещё не импортированы",
        "admin.tournaments.delete": "Удалить турнир",
        "admin.tournaments.deleteConfirm": "Удалить этот турнир и всех его участников? Это действие необратимо.",
        "admin.tournaments.noAccess": "У вас нет прав на управление турнирами.",
        ...
        "coach.cadence.active": "Активен",
        "coach.cadence.occasional": "Изредка",
        "coach.cadence.inactive": "Неактивен",
        ...
        "access.permissions.manageTournaments": "Управление турнирами",
        ...
        "leagues.leagueA": "Лига A",
        "leagues.leagueAPlus": "Лига A+",
        "leagues.leagueR": "Турнир Разрядников",
        ...
        "admin.ratings.viewUploads": "История загрузок",
        "admin.ratings.historyTitle": "История загрузок",
        "admin.ratings.colDocument": "Документ",
        "admin.ratings.colType": "Тип",
        "admin.ratings.colEffectiveDate": "Дата",
        "admin.ratings.colUploadedBy": "Загрузил",
        "admin.ratings.colUploadedAt": "Время загрузки",
        "admin.ratings.colRows": "Строк",
        "admin.ratings.colActions": "Действия",
        "admin.ratings.filterAll": "Все",
        "admin.ratings.filterTournament": "Турниры",
        "admin.ratings.filterRating": "Рейтинговые CSV",
        "admin.ratings.openBatch": "Открыть",
        "admin.ratings.unknownUser": "Неизвестно",
        "admin.ratings.empty": "Загрузок пока нет",
        "admin.ratings.import": "Импорт рейтингов",
        "admin.ratings.importCSV": "Импорт CSV",
        "admin.ratings.uploadCardTitle": "Загрузить документ",
        "admin.ratings.uploadHint": "Перетащите .csv / .xlsx файл сюда или нажмите, чтобы выбрать",
        ...
        "admin.ratings.creatingNewStudents": "Создаются новые ученики...",
        "admin.ratings.importingTournament": "Загружаются результаты турнира...",
        ...
        "admin.ratings.ambiguousMatch": "Несколько совпадений",
        "admin.ratings.selectCorrectStudent": "Выберите правильного ученика...",
        "admin.ratings.ambiguous": "неоднозначные",
        "admin.ratings.disambiguateAge": "Возраст",
        "admin.ratings.disambiguateDob": "Дата рождения",
        ...
        "admin.attendance.noStudentsForCoach": "У этого тренера пока нет учеников",
        ...
        // Time slot edit modal (P3)
        "admin.attendance.editTimeSlot.title": "Изменить время",
        "admin.attendance.editTimeSlot.startTime": "Начало",
        "admin.attendance.editTimeSlot.endTime": "Конец",
        "admin.attendance.editTimeSlot.label": "Название (необязательно)",
        "admin.attendance.editTimeSlot.labelPlaceholder": "напр. Группа Б",
        "admin.attendance.editTimeSlot.labelHelp": "Видно только в вашем календаре.",
        "admin.attendance.editTimeSlot.delete": "Удалить",
        "admin.attendance.editTimeSlot.cancel": "Отмена",
        "admin.attendance.editTimeSlot.save": "Сохранить",
        "admin.attendance.editTimeSlot.errBothTimes": "Укажите время начала и окончания.",
        "admin.attendance.editTimeSlot.errEndAfterStart": "Время окончания должно быть позже начала.",
        "admin.attendance.editTimeSlot.errSaveFailed": "Не удалось сохранить.",
        "admin.attendance.editTimeSlot.errDeleteFailed": "Не удалось удалить.",
        "admin.attendance.editTimeSlot.errPermission": "У вас нет прав на изменение этого слота. Обратитесь к админу.",
        "admin.attendance.editTimeSlot.deleteConfirm": "Удалить этот тайм-слот? Ученики, привязанные к этому индексу, потеряют свою привязку.",
        "admin.attendance.editTimeSlot.notAvailable": "У этого слота нет ID в базе (вероятно, резервная запись). Редактирование пока недоступно.",
        "admin.attendance.editTimeSlot.effectiveFromNote": "Изменения применяются с {month} и далее. Прошлые месяцы не меняются.",
        "admin.attendance.editTimeSlot.selectCoachToEdit": "Выберите тренера, чтобы редактировать слоты",
        "admin.attendance.addTimeSlot.button": "Добавить слот",
        "admin.attendance.addTimeSlot.title": "Добавить тайм-слот",
        "admin.attendance.addTimeSlot.startTime": "Начало",
        "admin.attendance.addTimeSlot.endTime": "Конец",
        "admin.attendance.addTimeSlot.label": "Название (необязательно)",
        "admin.attendance.addTimeSlot.labelPlaceholder": "напр. Группа Б",
        "admin.attendance.addTimeSlot.labelHelp": "Видно только в вашем календаре.",
        "admin.attendance.addTimeSlot.cancel": "Отмена",
        "admin.attendance.addTimeSlot.save": "Добавить",
        "admin.attendance.addTimeSlot.appliesFromNote": "Применяется с {month} и далее. Прошлые месяцы не меняются.",
        "admin.attendance.addTimeSlot.selectCoachFirst": "Сначала выберите конкретного тренера, чтобы добавить слот.",
        "admin.attendance.addTimeSlot.selectScheduleFirst": "Сначала выберите конкретное расписание, чтобы добавить слот.",
        "admin.attendance.addTimeSlot.selectBranchFirst": "Сначала выберите филиал, чтобы добавить слот.",
        "admin.attendance.addTimeSlot.errBothTimes": "Укажите время начала и окончания.",
        "admin.attendance.addTimeSlot.errEndAfterStart": "Время окончания должно быть позже начала.",
        "admin.attendance.addTimeSlot.errDuplicate": "Слот с таким временем начала и окончания уже существует.",
        "admin.attendance.addTimeSlot.errSaveFailed": "Не удалось добавить.",
        "admin.attendance.addMenu.button": "Добавить",
        "admin.attendance.addMenu.student": "Ученика",
        "admin.attendance.addMenu.timeSlot": "Временной слот",
        ...
        "admin.attendance.searchOutOfScope": "Этот ученик находится вне ваших филиалов",
        ...
        "admin.attendance.confirmHideStudent": "Скрыть {name} с {month}? Прошлые месяцы сохранят своё расписание.",
        ...
        "admin.attendance.studentHidden": "{name} скрыт с {month}",
        ...
        "admin.coachKpi.kind.rated": "Рейтинговый турнир",
        "admin.imports.roundsRequired": "Для рейтинговых турниров требуется количество туров (1–20)",
        "admin.imports.roundsFixedMismatch": "У этого типа турнира фиксированное количество туров — выберите «Рейтинговый турнир» для другого значения",
        ...
        "tournaments.appRegisterNote": "Регистрация проходит в приложении Chess Empire — участвовать могут только зарегистрированные пользователи приложения.",
        ...
        "tournaments.ineligibleForLeague": "Регистрация невозможна — ваш рейтинг ({{rating}}) соответствует Лиге {{studentLeague}}, а не Лиге {{league}}.",
        "tournaments.levelTooLow": "Регистрация невозможна — для Лиги C нужен Уровень {{required}}+. Вы на Уровне {{level}}: завершите уроки Уровня {{level}}, чтобы открыть турниры Лиги C.",
        "tournaments.noRazryad": "Регистрация доступна только ученикам с разрядом.",
        "tournaments.guestsAdminOnly": "Гостей в турниры разрядников может добавлять только администратор.",
        "tournaments.titledOnlyNote": "Регистрация доступна только ученикам с разрядом.",
        ...
        "tournaments.fee.kzt": "{{amount}} ₸",
        "tournaments.fee.free": "Бесплатно",
        "tournaments.registration.closesAt": "Закрытие регистрации: {{datetime}}",
        "tournaments.startAt": "Старт {{time}}",
        "tournaments.countdown.label": "До закрытия регистрации",
        "tournaments.countdown.days": "ДНЕЙ",
        "tournaments.countdown.hours": "ЧАСОВ",
        "tournaments.countdown.minutes": "МИНУТ",
        "tournaments.countdown.seconds": "СЕК",
        ...
        "admin.tournaments.col.branch": "Филиал",
        "admin.tournaments.col.name": "Название",
        "admin.tournaments.col.date": "Дата",
        "admin.tournaments.col.time": "Время",
        "admin.tournaments.col.format": "Формат",
        "admin.tournaments.col.fee": "Взнос",
        "admin.tournaments.col.rounds": "Туры",
        "admin.tournaments.col.status": "Статус",
        "admin.tournaments.col.registered": "Зарегистрировано",
        "admin.tournaments.col.actions": "Действия",
        "admin.tournaments.col.surname": "Фамилия",
        "admin.tournaments.col.firstName": "Имя",
        "admin.tournaments.col.rating": "Рейтинг",
        "admin.tournaments.col.coach": "Тренер",
        "admin.tournaments.col.age": "Возраст",
        "admin.tournaments.action.edit": "Редактировать",
        "admin.tournaments.action.cancel": "Отменить",
        "admin.tournaments.action.delete": "Удалить",
        "admin.tournaments.action.remove": "Удалить",
        "admin.tournaments.action.viewParticipants": "Посмотреть участников",
        "admin.tournaments.downloadExcel": "Скачать Excel",
        "admin.tournaments.excelFilenamePrefix": "Участники",
        "admin.tournaments.status.open": "Открыт",
        "admin.tournaments.status.closed": "Закрыт",
        ...
        "admin.tournaments.form.timeFormat": "Контроль времени",
        "admin.tournaments.form.fee": "Регистрационный взнос (тенге)",
        "admin.tournaments.form.rounds": "Количество туров",
        "admin.tournaments.form.capacity": "Вместимость",
        "admin.tournaments.form.status": "Статус",
        "admin.tournaments.form.league": "Лига",
        "admin.tournaments.form.deadline": "Дедлайн регистрации",
        "admin.tournaments.confirmDelete": "Удалить этот турнир? Все регистрации также будут удалены.",
        "admin.tournaments.confirmCancel": "Отменить этот турнир? Существующие регистрации сохранятся, но новые добавить нельзя.",
        "admin.tournaments.confirmRemove": "Удалить эту регистрацию?",
        "admin.tournaments.created": "Турнир создан",
        "admin.tournaments.updated": "Турнир обновлен",
        "admin.tournaments.deleted": "Турнир удален",
        "admin.tournaments.cancelled": "Турнир отменен",
        "admin.tournaments.registrationRemoved": "Регистрация удалена",
        "admin.tournaments.removeError.not_found": "Регистрация уже удалена",
        "admin.tournaments.error": "Ошибка",
        "admin.tournaments.accessDenied": "Доступ запрещен",
        "admin.tournaments.selectTournament": "Выберите турнир",
        "admin.tournaments.noRegistrations": "Регистраций пока нет",
        "admin.tournaments.noTournaments": "Турниров пока нет",
        ...
        "admin.tournaments.addGuest": "+ Добавить гостя",
        "admin.tournaments.guestBadge": "Гость",
        "admin.tournaments.col.phone": "Телефон",
        "admin.tournaments.col.email": "Email",
        "admin.tournaments.guestModal.title": "Добавить гостя",
        "admin.tournaments.guestForm.firstName": "Имя",
        "admin.tournaments.guestForm.lastName": "Фамилия",
        "admin.tournaments.guestForm.phone": "Телефон",
        "admin.tournaments.guestForm.age": "Возраст",
        "admin.tournaments.guestForm.rating": "Рейтинг (необязательно)",
        "admin.tournaments.guestForm.submit": "Зарегистрировать гостя",
        "admin.tournaments.guestRegistered": "Гость зарегистрирован.",
        "admin.tournaments.duplicateGuest": "Этот email уже зарегистрирован на этот турнир.",
        "admin.tournaments.ineligibleGuest": "Рейтинг не соответствует лиге {tournament_league} (гость попадает в лигу {guest_league}).",
        "admin.tournaments.form.leagueR": "Титульный / Турнир Разрядников (R)",
        "admin.tournaments.noRazryad": "У этого ученика нет разряда — он не может сам зарегистрироваться в турнир разрядников.",
        "admin.tournaments.guestsAdminOnly": "Добавлять гостей в турниры разрядников могут только администраторы.",
        "admin.tournaments.invalid_first_name": "Укажите имя.",
        "admin.tournaments.invalid_last_name": "Укажите фамилию.",
        "admin.tournaments.invalid_phone": "Телефон выглядит некорректно — используйте +7 (XXX) XXX-XX-XX.",
        "admin.tournaments.invalid_email": "Этот email выглядит некорректно.",
        "admin.tournaments.invalid_age": "Возраст должен быть от 4 до 99.",
        "admin.tournaments.invalid_rating": "Рейтинг должен быть от 0 до 3500."
    }
};
    ...
    const translations = {
        en: {
            ...
            admin: {
                ...
                coachKpi: {
                    uploadButton: 'Upload tournament',
                    uploadTitle: 'Upload tournament',
                    uploadKind: 'Tournament type',
                    uploadFile: 'Swiss-Manager export (.xlsx / .html)',
                    uploadDate: 'Tournament date',
                    uploadCommit: 'Commit upload',
                    previewMatched: 'Matched',
                    previewAmbiguous: 'Ambiguous',
                    previewUnmatched: 'Unmatched',
                    uploadSuccess: 'Upload committed — leaderboard refreshed',
                    uploadError: 'Could not upload tournament',
                    noDataYet: 'No data yet for this window.',
                    kind: {
                        league_c: 'League C',
                        league_b: 'League B',
                        razryad_3: '3rd razryad qualification',
                        razryad_4: '4th razryad qualification'
                    },
                    rank: '#',
                    colCoach: 'Coach',
                    colBranch: 'Branch',
                    colActive: 'Active students',
                    colEntries: 'Tournament entries',
                    colAvgDelta: 'Avg rating delta',
            ...
            coachKpiRazryad3rd: '3rd',
            coachKpiRazryad4th: '4th',
            coachKpiRazryadNone: 'None',
            coachKpiTournaments: 'Tournaments',
            ...
            coachKpiDrillStudent: 'Student',
            coachKpiDrillBranch: 'Branch',
            coachKpiDrillCoach: 'Coach',
            coachKpiDrillLeague: 'League',
            coachKpiDrillRazryad: 'Razryad',
            coachKpiDrillTournament: 'Tournament',
            coachKpiDrillDate: 'Date',
            coachKpiDrillBack: '← Back',
            coachKpiDrillRow: 'row',
            coachKpiDrillRows: 'rows',
            coachKpiDrillGames: 'Games',
            coachKpiDrillTournamentsPlayed: 'Tournaments',
            coachKpiDrillRatingDelta: 'Rating Δ',
            coachKpiDrillPlacement: 'Placement',
            coachKpiDrillOldRazryad: 'Old razryad',
            coachKpiDrillNewRazryad: 'New razryad',
            coachKpiDrillEarnedAt: 'Earned',
            coachKpiDrillFrom: 'From',
            coachKpiDrillTo: 'To',
            coachKpiDrillOccurredAt: 'Promoted',
            coachKpiDrillTitle_active_players: 'Active players',
            coachKpiDrillTitle_top3: 'Top-3 finishes',
            coachKpiDrillTitle_new_razryads: 'New razryads',
            coachKpiDrillTitle_promotions: 'Promotions'
        },
        ru: {
            general: {
                brandName: 'Chess Empire',
            ...
            admin: {
                ...
                coachKpi: {
                    uploadButton: 'Загрузить турнир',
                    uploadTitle: 'Загрузка турнира',
                    uploadKind: 'Тип турнира',
                    uploadFile: 'Экспорт Swiss-Manager (.xlsx / .html)',
                    uploadDate: 'Дата турнира',
                    uploadCommit: 'Подтвердить загрузку',
                    previewMatched: 'Сопоставлено',
                    previewAmbiguous: 'Неоднозначно',
                    previewUnmatched: 'Не найдено',
                    uploadSuccess: 'Загрузка подтверждена — таблица обновлена',
                    uploadError: 'Не удалось загрузить турнир',
                    noDataYet: 'Данных за этот период пока нет.',
                    kind: {
                        league_c: 'Лига C',
                        league_b: 'Лига B',
                        razryad_3: 'Квалификация 3-го разряда',
                        razryad_4: 'Квалификация 4-го разряда'
                    },
                    rank: '№',
                    colCoach: 'Тренер',
                    colBranch: 'Филиал',
                    colActive: 'Активные ученики',
                    colEntries: 'Турнирные участия',
                    colAvgDelta: 'Средний прирост рейтинга',
                    colTop3: 'Топ-3 места',
            ...
            coachKpiTimeWindowGroup: 'Период',
            ...
            coachKpiCoachAll: 'Все тренеры',
            coachKpiCoachGroup: 'Тренер',
            ...
            coachKpiDrillStudent: 'Ученик',
            coachKpiDrillBranch: 'Филиал',
            coachKpiDrillCoach: 'Тренер',
            coachKpiDrillLeague: 'Лига',
            coachKpiDrillRazryad: 'Разряд',
            coachKpiDrillTournament: 'Турнир',
            coachKpiDrillDate: 'Дата',
            coachKpiDrillBack: '← Назад',
            coachKpiDrillRow: 'строка',
            coachKpiDrillRows: 'строк',
            coachKpiDrillGames: 'Партии',
            coachKpiDrillTournamentsPlayed: 'Турниры',
            coachKpiDrillRatingDelta: 'Прирост рейтинга',
            coachKpiDrillPlacement: 'Место',
            coachKpiDrillOldRazryad: 'Старый разряд',
            coachKpiDrillNewRazryad: 'Новый разряд',
            coachKpiDrillEarnedAt: 'Получен',
            coachKpiDrillFrom: 'Из',
            coachKpiDrillTo: 'В',
        ...
        kk: {
            admin: {
                coachKpi: {
                    uploadButton: 'Турнир жүктеу',
                    uploadTitle: 'Турнирді жүктеу',
                    uploadKind: 'Турнир түрі',
                    uploadFile: 'Swiss-Manager экспорты (.xlsx / .html)',
                    uploadDate: 'Турнир күні',
                    uploadCommit: 'Жүктеуді растау',
                    previewMatched: 'Сәйкестендірілген',
                    previewAmbiguous: 'Күмәнді',
                    previewUnmatched: 'Табылмаған',
                    uploadSuccess: 'Жүктеу расталды — кесте жаңартылды',
                    uploadError: 'Турнирді жүктеу мүмкін болмады',
                    noDataYet: 'Бұл кезеңде әзірге деректер жоқ.',
                    kind: {
                        league_c: 'C лигасы',
                        league_b: 'B лигасы',
                        razryad_3: '3-разряд біліктілігі',
                        razryad_4: '4-разряд біліктілігі'
                    },
                    rank: '№',
                    colCoach: 'Жаттықтырушы',
                    colBranch: 'Бөлімше',
                    colActive: 'Белсенді оқушылар',
                    colEntries: 'Турнирге қатысулар',
                    colAvgDelta: 'Орташа рейтинг өсімі',
                    colTop3: 'Топ-3 орын',
            ...
            coachKpiTimeWindow90d: '90 күн',
            coachKpiTimeWindowYtd: 'Жыл басынан',
            coachKpiTimeWindowGroup: 'Кезең',
            coachKpiWindowGroup: 'Кезең',
            coachKpiLeagueAll: 'Барлық турнирлер',
            ...
            coachKpiCoachAll: 'Барлық жаттықтырушылар',
            coachKpiCoachGroup: 'Жаттықтырушы',
            ...
            coachKpiDrillStudent: 'Оқушы',
            coachKpiDrillBranch: 'Бөлімше',
            coachKpiDrillCoach: 'Жаттықтырушы',
            coachKpiDrillLeague: 'Лига',
            coachKpiDrillRazryad: 'Разряд',
            coachKpiDrillTournament: 'Турнир',
            coachKpiDrillDate: 'Күні',
            coachKpiDrillBack: '← Артқа',
            coachKpiDrillRow: 'жол',
            coachKpiDrillRows: 'жол',
            coachKpiDrillGames: 'Партиялар',
            coachKpiDrillTournamentsPlayed: 'Турнирлер',
            coachKpiDrillRatingDelta: 'Рейтинг өсімі',
            coachKpiDrillPlacement: 'Орын',
            coachKpiDrillOldRazryad: 'Ескі разряд',
            coachKpiDrillNewRazryad: 'Жаңа разряд',
            coachKpiDrillEarnedAt: 'Алынды',
            coachKpiDrillFrom: 'Қайдан',
            coachKpiDrillTo: 'Қайда',
