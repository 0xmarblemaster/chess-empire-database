...
const translations = {
    en: {
        ...
        "admin.attendance.monWed": "Mon-Wed-Fri",
        ...
        "admin.attendance.excelFormatHint": "Upload attendance journal in .xlsx format (sheets: Mon-Wed-Fri, Tue-Thu, Sat-Sun)",
    ...
    kk: {
        ...
        "admin.attendance.monWed": "Дс-Ср-Жм",
        ...
        "admin.attendance.excelFormatHint": ".xlsx форматында қатысу журналын жүктеңіз (парақтар: Дс-Ср-Жм, Сс-Бс, Сб-Жс)",
    ...
    ru: {
        ...
        "admin.attendance.monWed": "Пн-Ср-Пт",
        ...
        "admin.attendance.excelFormatHint": "Загрузите журнал посещаемости в формате .xlsx (листы: Пн-Ср-Пт, Вт-Чт, Сб-Вс)",
