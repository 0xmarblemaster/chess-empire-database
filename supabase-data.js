...
const supabaseData = {
    ...
    async getStudents() {
        ...
        return rows.map(student => ({
            ...
            razryad: student.razryad,            status: student.status,
    ...
    async getStudentById(id) {
        ...
        return {
            ...
            razryad: data.razryad,            status: data.status,
    ...
    async addStudent(studentData) {
        const { data, error } = await window.supabaseClient
            ...
            .insert([{
                ...
                razryad: studentData.razryad || 'none',                status: studentData.status || 'active',
    ...
    async updateStudent(id, studentData) {
        const { data, error } = await window.supabaseClient
            ...
            .update({
                ...
                branch_id: studentData.branchId,
                coach_id: studentData.coachId,
                razryad: studentData.razryad,                status: studentData.status,
